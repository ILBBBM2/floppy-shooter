...
pre-release build for windows: [download](https://github.com/ILBBBM2/floppy-shooter/releases/download/v1.0.0/finished-game-main.zip)
...
## proof that it runs on a floppy disk


https://github.com/user-attachments/assets/fa3adc2f-deef-48af-9bb3-f020301a2a9e
